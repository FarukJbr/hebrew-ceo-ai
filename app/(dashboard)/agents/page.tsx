...
const departments = [
  ...
  { id: 7, name: 'טכנולוגיה',    agent: 'רון',   role: 'IT AI',         description: 'מנהל תשתיות, אבטחת מידע ומערכות טכנולוגיות',             status: 'standby', tasksCompleted: 45, tasksOpen: 0, lastAction: 'בדיקת אבטחה חודשית — לפני 3 ימים',        specialty: ['תשתיות','אבטחה','טכנולוגיה'],   color: 'purple' },
